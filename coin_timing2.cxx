...
void coin_timing2(int RunNumber = 6012, const char* codatype = "COIN", int nevents = 500000) {
  ...
  auto h_test2 = dderp3.Histo1D({"h_test2", ";time_fix_maybe", 800, -400, 400}, "delta_s1xs_1" );
  auto h_test3 = dderp3.Histo1D({"h_test3", ";time_fix_maybe", 800, -400, 400 }, "delta_s1xs_2" );
  auto h_test4 = dderp3.Histo1D({"h_test3", ";time_fix_maybe", 800, -400, 400 }, "delta_s1xs_3" );

  auto h_test  = dderp3.Histo2D({"h_test", ";CTime.ePiCoinTime_ROC2;T.coin.p1X_tdcTime", 2000, 0, 100, 800, -400, 400}, "CTime.ePiCoinTime_ROC2","delta_s1xs_1" );

  auto h_coin_time1 = d2.Histo1D( {"coin_time", "coin_time", 2000, -400,400}, "CTime.ePiCoinTime_ROC1");
  auto h_coin_time2 = d2.Histo1D( {"coin_time", "coin_time", 2000, -400,400}, "CTime.ePiCoinTime_ROC2");
  ...
  TH2F* h23 = new TH2F("h23","h2", 100, 240, 320, 100, 40, 70);
  ...
  //h_Trig1_m_Trig4_roc1->DrawCopy();
  //h_Trig1_m_Trig4_roc2->SetLineColor(2);
  //h_Trig1_m_Trig4_roc2->DrawCopy("same");
