...
void plot_jpsi_masses_phase4(int start_run = 0) {

  auto mcFile          = new TFile("monitoring/simulation/mc-histos-phase4.root");
  ...
  ddisplay->CreateDisplayPlot(
      ...
      [&](hallc::DisplayPlot& plt) {
        ...
        c->SaveAs("results/plot_jpsi_masses/c1-4.png");
        c->SaveAs("results/plot_jpsi_masses/c1-4.pdf");
        return 0;
      },
      [&](hallc::DisplayPlot& plt) { return 0; });
  ddisplay->CreateDisplayPlot(
      "total", "E_gamma_phase4",
      [&](hallc::DisplayPlot& plt) {
        auto c = plt.SetCanvas(new TCanvas(plt.GetName().c_str(), plt.GetName().c_str()));
        // plt.SetPersist();
        c->cd();
...
#endif
        leg->Draw();
        c->SaveAs("results/plot_jpsi_masses/c2-4.png");
        c->SaveAs("results/plot_jpsi_masses/c2-4.pdf");
  ...
  ddisplay->CreateDisplayPlot(
      ...
      [&](hallc::DisplayPlot& plt) {
        ...
        c->SaveAs("results/plot_jpsi_masses/c3-4.png");
        c->SaveAs("results/plot_jpsi_masses/c3-4.pdf");
