...
void make_shms_table() {
  ...
  for (json::iterator it = j.begin(); it != j.end(); ++it) {
    ...
    if ((p_shms != runjs["spectrometers"]["hms_momentum"].get<double>()) ||
        (th_shms != runjs["spectrometers"]["hms_angle"].get<double>())) {
      print_header();
    }

    p_shms  = runjs["spectrometers"]["hms_momentum"].get<double>();
    th_shms = runjs["spectrometers"]["hms_angle"].get<double>();
